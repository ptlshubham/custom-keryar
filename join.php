...
require './PHPMailer.php';
    ...
    $form_phone = $_REQUEST['form_phone'];
    $form_message = $_REQUEST['form_message'];
    $form_city = $_REQUEST['form_city'];
    $form_zip = $_REQUEST['form_zip'];
    $form_country = $_REQUEST['form_country'];
    $form_state = $_REQUEST['form_state'];
    $file = $_REQUEST['file'];
    $form_des = $_REQUEST['form_des'];
                                                                         ...
                                                                         <tr>
                                                                            <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                                               <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px; text-align: left; color: #4F4F4F;">
                                                                                  ...
                                                                                  <ul>
                                                                                     <li><strong>Name</strong> - '.$form_name.' '. $form_lname.'</li>
                                                                                     <li><strong>Email</strong> -'. $form_email.'</li>
                                                                                     <li><strong>Phone Number</strong> - '.$form_phone.'</li>
                                                                                     <li><strong>City</strong> -'. $form_city.'</li>
                                                                                     <li><strong>Message</strong> -'. $form_message.'</li>
                                                                                     <li><strong>Zip Code</strong> -'. $form_zip.'</li>
                                                                                     <li><strong>Country</strong> -'. $form_country.'</li>
                                                                                     <li><strong>State</strong> -'. $form_state.'</li>
                                                                                     <li><strong>Resume</strong> -'. $file.'</li>
                                                                                     <li><strong>Self Description</strong> -'. $form_des.'</li>'.$html_for_cer.'
