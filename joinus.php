...
require './PHPMailer.php';
    ...
    $depa = $_REQUEST['dep'];
    $ddlViewBy = $_REQUEST['ddlViewBy'];
    if($ddlViewBy=='certificate'){
        $language=$_REQUEST['tab2'];
        $period=$_REQUEST['tab3'];
        $sdate=$_REQUEST['tab34'];
        $edate=$_REQUEST['tab35'];
        $html_for_cer=' <li><strong>Choose Internship Method</strong> - Direct certificate for the Internship</li>
                        <li><strong>Language</strong> - '.$language.'</li>
                        <li><strong>Internship time peroid(month)</strong> - '.$period.'</li>
                        <li><strong>Starting & End Date</strong> -'. $sdate.' to '.$edate.'</li>';
    }
    else{
        $language=$_REQUEST['tab6'];
        $project=$_REQUEST['tab1'];
        $knowledge_of_lan=$_REQUEST['tab10'];
        $period=$_REQUEST['tab16'];
        $sdate=$_REQUEST['tab32'];
        $edate=$_REQUEST['tab33'];
        $time_to=$_REQUEST['tab17'];
        $time_from=$_REQUEST['tab18'];
        $html_for_cer=' <li><strong>Choose Internship Method</strong> - Internship for new technology or a language</li>
                        <li><strong>Language</strong> - '.$language.'</li>
                        <li><strong>live project or just hands on traning</strong> - '.$project.'</li>
                        <li><strong>knowloage</strong> - '.$knowledge_of_lan.'</li>
                        <li><strong>Internship time peroid(month)</strong> - '.$period.'</li>
                        <li><strong>Starting & End Date</strong> -'. $sdate.' to '.$edate.'</li>
                        <li><strong>Timing what you prepered</strong> - '.$time_to.' to '. $time_from.'</li>';
    }
    
    //Recipients
    $mail->setFrom('hello@keryar.com', 'InternShip');
    $mail->addAddress($email, $name); 
    $mail->addAddress('hello@keryar.com', 'keryar Internship'); 
                                                                      ...
                                                                      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style width="100%">
                                                                         <tr>
                                                                            <td align="left" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                                               <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 26px; font-weight: bold; line-height: 30px; text-align: left; color: #4F4F4F;">Internship Confirmation!</div>
                                                                            </td>
                                                                         </tr>
                                                                         <tr>
                                                                            <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                                               <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px; text-align: left; color: #4F4F4F;">
                                                                                  ...
                                                                                  <ul>
                                                                                     <li><strong>Name</strong> - '.$name.' '. $lname.'</li>
                                                                                     <li><strong>Email</strong> -'. $email.'</li>
                                                                                     <li><strong>Phone Number</strong> - '.$phone.'</li>
                                                                                     <li><strong>City</strong> -'. $city.'</li>
                                                                                     <li><strong>Collage Name</strong> -'. $cname.'</li>
                                                                                     <li><strong>Deprtment</strong> -'. $depa.'</li>
                                                                                     <li><strong>Semester</strong> -'. $sem.'</li>'.$html_for_cer.'
